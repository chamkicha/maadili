...
class EsbHelper
{
    ...
    {
        $this->clientId = config("govesb.client-id");
        $this->clientSecret = config("govesb.client-secret");
        $this->clientPrivateKey = config("govesb.private-key");
        $this->esbPublicKey = config("govesb.esb-public-key");
        $this->esbTokenUrl = config("govesb.esb-token-url");
        $this->esbEngineUrl = config("govesb.esb-engine-url");
        $this->nidaUserId = config("govesb.nida-user-id");
    ...
    {
        Log::info("Request to GovESB: $requestBody");
