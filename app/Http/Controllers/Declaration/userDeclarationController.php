...
class userDeclarationController extends Controller
{
    ...
    public function previewAdfReturned(Request $request)
    {
        $year = Financial_year::where('is_active', '=', 1)->first();
          $declaration = User_declaration::with([
            'declaration_type' => function ($query) {
    ...
    public function confirmDeclarationPreviewReturned(Request $request): JsonResponse
    {
    ...
    public function downloadAdfReturned(Request $request): JsonResponse
    {
        $year = Financial_year::where('is_active', '=', 1)->first();
          $declaration = User_declaration::with([
            'declaration_type' => function ($query) {
